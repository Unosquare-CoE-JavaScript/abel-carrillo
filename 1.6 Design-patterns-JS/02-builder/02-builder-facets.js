/** Sometimes a code is so complicated that you
 * need several builders to build up different
 * aspects of your object.
 * In this case we have a kind of parent builder,
 * a base class builder that allows you to jump from
